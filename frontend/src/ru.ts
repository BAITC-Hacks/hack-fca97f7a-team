export const ru = {
  ...
  notice: 'Демонстрационная погода и условные координаты. Измерения турбин и обученные модели основаны на реальных данных. Мощность нормализована от 0 до 1; это не МВт и не МВт·ч.',
  configure: '01 / ПАРАМЕТРЫ', selectForecast: 'Настройка прогноза', selectHint: 'Выберите зарегистрированную турбину и дату запуска.',
  registeredTurbine: 'ЗАРЕГИСТРИРОВАННАЯ ТУРБИНА', coordinates: 'Условные координаты',
  mapHint: 'Метки на карте расположены условно. Нажатие выбирает зарегистрированную турбину.',
  ...
  awaiting: 'ОЖИДАНИЕ ПРОГНОЗА', emptyTitle: 'Прогноз на 24 или 48 часов', emptyText: 'Выберите турбину и сформируйте прогноз, чтобы увидеть почасовой график, входной CSV модели и анализ.',
  ...
  analysis: '03 / АНАЛИЗ', analysisTitle: 'Что показывает прогноз', aiExplanation: 'Объяснение ИИ', computedExplanation: 'Расчётное объяснение — ИИ недоступен',
  ...
  advance: 'Следующий день и новый прогноз', footer: 'ИЗМЕРЕНИЯ ТУРБИН · ДЕМОНСТРАЦИОННАЯ ПОГОДА · НОРМАЛИЗОВАННАЯ МОЩНОСТЬ',
  noSites: 'Нет доступных зарегистрированных турбин.', noArchiveSites: 'Для архивного режима не настроены проверенные координаты турбин.',
...
export const coordinateLabel = (value: string) => value === 'fixture' ? ru.coordinates : value === 'verified' ? 'Проверенные координаты' : ru.coordinates
